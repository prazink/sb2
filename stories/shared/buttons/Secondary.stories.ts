...
const meta:Meta<typeof LFButton> = {
  title: 'Shared/Buttons/Secondary',
  tags: ['autodocs'],
  component: LFButton,
  render: args => ({
    components: { LFButton },
    ...
    template: '<LFButton variant="secondary" v-bind="args">Button</LFButton>',
  }),
  argTypes: {
    variant: {
      table: {
...
export const WithIcon: Story = {
  render: args => ({
    ...
    template: `
      <LFButton variant="secondary" v-bind="args">
        Button
