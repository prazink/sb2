...
const meta: Meta<typeof LFButton> = {
  title: 'Shared/Buttons/Tertiary',
  tags: ['autodocs'],
  component: LFButton,
  render: args => ({
    components: { LFButton },
    setup () {
      return { args, variant: ButtonVariantEnum.TERTIARY }
    },
    template: '<LFButton :variant="variant" v-bind="args">Button</LFButton>',
  }),
  argTypes: {
    variant: {
      table: {
...
export const WithIcon: Story = {
  render: args => ({
    ...
    template: `
      <LFButton :variant="variant" v-bind="args">
        Button
